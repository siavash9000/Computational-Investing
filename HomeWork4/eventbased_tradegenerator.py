...
def find_events(ls_symbols, d_data, orders_filename):
    ...
    writer = csv.writer(open(orders_filename,'wb'),delimiter=',')
...
if __name__ == '__main__':
    ...
    df_events = find_events(ls_symbols, d_data, "orders.csv")
    print "found ", len(df_events), " events"
